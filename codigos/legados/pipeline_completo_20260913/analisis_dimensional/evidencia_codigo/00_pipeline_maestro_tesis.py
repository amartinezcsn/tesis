...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Carpeta para las gráficas y sus manifiestos.",
    )
    parser.add_argument(
        "--desde",
        choices=STAGE_ORDER,
...
def write_execution_products(
    ...
    manifest = {
        ...
        "configuracion": {
            ...
            "graphics_dir": str(args.graphics_dir.resolve()),
            "desde": args.desde,
            "hasta": args.hasta,
...
def main() -> int:
    ...
    args.graphics_dir = args.graphics_dir.expanduser()
